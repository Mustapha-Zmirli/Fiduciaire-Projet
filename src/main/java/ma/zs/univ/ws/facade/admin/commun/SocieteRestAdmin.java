...
public class SocieteRestAdmin  extends AbstractController<Societe, SocieteDto, SocieteCriteria, SocieteAdminService, SocieteConverter> {
    ...
    @Operation(summary = "Finds a societe by code")
    @GetMapping("code/{code}")
    public ResponseEntity<SocieteDto> findByCode(@PathVariable String code) {
        return super.findByReferenceEntity(new Societe(code));
    }
