...
public class PaiementDemandeRestAdmin  extends AbstractController<PaiementDemande, PaiementDemandeDto, PaiementDemandeCriteria, PaiementDemandeAdminService, PaiementDemandeConverter> {
    ...
    @Operation(summary = "Finds a paiementDemande by libelle")
    @GetMapping("libelle/{libelle}")
    public ResponseEntity<PaiementDemandeDto> findByLibelle(@PathVariable String libelle) {
        return super.findByReferenceEntity(new PaiementDemande(libelle));
    }
