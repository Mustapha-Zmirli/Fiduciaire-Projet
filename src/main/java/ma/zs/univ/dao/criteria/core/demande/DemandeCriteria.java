...
public class DemandeCriteria extends  BaseCriteria  {
    ...
    private String typeDemandeLike;
    private String etatDemande;
    private String etatDemandeLike;
    ...
    public String getTypeDemandeLike(){
        return this.typeDemandeLike;
    }
    public void setTypeDemandeLike(String typeDemandeLike){
        this.typeDemandeLike = typeDemandeLike;
    }
    ...
    public String getEtatDemandeLike(){
        return this.etatDemandeLike;
    }
    public void setEtatDemandeLike(String etatDemandeLike){
        this.etatDemandeLike = etatDemandeLike;
    }
